...
fun CustomCodeScannerScreen2(
    ...
    CustomCodeScannerScreenContent2(
        ...
        onEvent = { event ->
            when (event) {
                is CustomCodeScannerScreenUserEvent2.CloseClicked -> {
                    onCloseClicked()
                }
                else -> customCodeScannerViewModel2.onEvent(event)
            }
        }
    )
}
    ...
    Scaffold(containerColor = Color.White) { paddingValues ->
        Box {
            ...
            Row(
                ...
                IconButton(onClick = { onEvent(CustomCodeScannerScreenUserEvent2.CloseClicked) }) {
                    Icon(
                ...
                IconButton(onClick = { onEvent(CustomCodeScannerScreenUserEvent2.ToggleFlash) }) {
                    Icon(
                        imageVector =
...
@Preview
@Composable
private fun CustomCodeScannerScreenContent2Preview() {
    QRAlarmTheme {
        CustomCodeScannerScreenContent2(
            state = CustomCodeScannerScreenState2(),
            onEvent = {}
